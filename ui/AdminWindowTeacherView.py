...
def teacher_view(window, return_function):
	...
	teachingCourses_button = Button(window, text = "View Teaching Courses",fg = "#00ace6", font="Arial 14 bold",height = 1, width = 20, cursor = get_handcursor(), command = partial(teaching_courses,window, return_function))
