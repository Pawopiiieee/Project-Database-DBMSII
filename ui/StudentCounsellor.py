...
def student_personal_counsellor(window, return_function): #this is going to show personal data
	...
	special_circumstances_button = Button(window, text = "Special Circumstances", fg = "#1f3d7a", font="Arial 10 bold",height = 1,width = 25, cursor = get_handcursor(),command = partial(contact_counsellor,window,return_function))
	...
	financial_problem_button = Button(window, text = "Financial Problems", fg = "#1f3d7a", font="Arial 10 bold",height = 1,width = 25, cursor = get_handcursor(),command = partial(contact_counsellor,window,return_function))
	...
	disability_button = Button(window, text = "Study with a Disability or a Chronic Illness", fg = "#1f3d7a", font="Arial 10 bold",height = 1,width = 35, cursor = get_handcursor(),command = partial(contact_counsellor,window,return_function))
