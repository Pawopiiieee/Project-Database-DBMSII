...
#view part
	...
	for i in range (len(studentIncourse)):
		...
		studentName_label = Label(window, text = str(person.lname) + "  "+ str(person.fname),fg = "#00293c", font = "Arial 10", height = 2, width = 25,relief="ridge",borderwidth=2)
		studentName_label.place(x = 20, y = num_pos_y, width = 250,height = 30)

		studentID_label = Label(window, text = studentIncourse[i].studentID,fg = "#00293c", font = "Arial 10",  height = 2, width = 13,relief="ridge",borderwidth=2)
