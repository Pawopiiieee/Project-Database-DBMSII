...
#view part
	...
	title_label = Label(window,text = "Course Title ", fg = "#006386", font = "Arial 16 bold", bg ="#EBEBE9")
	title_label.place(x = 20, y = 100)

	credit_label = Label(window,text = "Credits", fg = "#006386", font = "Arial 16 bold", bg ="#EBEBE9")
	credit_label.place(x = 20, y = 130)

	student_name_label = Label(window, text = "Student Name", fg = "#e6b800", font="Arial 10 bold",height = 1, width = 25,bg ="#006386")
	...
	submit_text = Button(window, text = "Submit",font = "Arial 20 bold",fg = "#006386",highlightbackground ="#48C9B0",height = 2, width = 6, command = confirm_submit,cursor = get_handcursor())
