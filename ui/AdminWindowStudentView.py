...
def student_view(window, return_function, student, person):
	...
	studentID_info.place(x = 120, y = 120)
	...
	studentCounsellor_info = Label(window,text = student.studyCouncelor, fg = "#006386", font = "Arial 10 bold", bg ="#EBEBE9")
	studentCounsellor_info.place(x = 120, y = 160)
