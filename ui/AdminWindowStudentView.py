...
def student_view(window, return_function):
	...
	enrollCourses_button = Button(window, text = "View Enrolled Courses",fg = "#00ace6", font="Alice 16 bold",height = 2, width = 18, cursor = "pointinghand", command = partial(enrolledCourses_students,window, return_function))
