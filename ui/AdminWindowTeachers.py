...
def admin_window_teachers(window,return_function): 
	...
	for i in range (len(teachers)):
		...
		view_button = Button(window, text = "View",font = "Alice 14", fg = "#006386",highlightbackground = "#ccd9ff",cursor = "pointinghand", height = 1,width = 4, relief = FLAT, command = partial(teacher_view,window,return_function))
		view_button.place(x= 330, y = y_position)
		edit_button = Button(window, text = "Edit",font = "Alice 14", fg = "#006386",highlightbackground = "#fff2cc",cursor = "pointinghand", height = 1,width = 4, relief = FLAT,command = partial(teacher_edit,window,return_function))
