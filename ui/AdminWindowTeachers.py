...
def admin_window_teachers(window,return_function):
	...
	create_data_text = Button(text = "Create new data", fg = "#e6b800", font="Arial 12", width = 15, cursor = get_handcursor(), highlightbackground =  "#006386", command = partial(createNew_teacher,window,return_function))
	create_data_text.place(x=20, y = 80,height = 40)

	header_label1 = Label(window, text = "#",fg = "#e6b800", font="Arial 10 bold", width = 3,bg ="#006386")
	header_label1.place(x=10, y =130, height=30)
	header_label2 = Label(window, text = "Lastname",fg = "#e6b800", font="Arial 10 bold", width = 17,bg ="#006386")
	header_label2.place(x=40, y = 130, height=30)
	header_label3 = Label(window, text = "Firstname",fg = "#e6b800", font="Arial 10 bold", width = 17,bg ="#006386" )
	header_label3.place(x=180, y = 130, height=30)
	...
	for i in range (len(teachers)):
		...
		#initial_num += 1
		course_label = Label(window, text = teachers[i],fg = "#00293c", font = "Arial 13", height = 2, width = 15)
