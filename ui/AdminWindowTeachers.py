...
def admin_window_teachers(window,return_function):
	...
	for i in range (len(teachers)):
		...
		#initial_num += 1
		teacherL_label = Label(window, text = person.lname,fg = "#00293c", font = "Arial 10", height = 2, width = 15)
		teacherL_label.place(x = 40, y = num_pos_y, width = 140, height=30)

		teacherF_label = Label(window, text = person.fname,fg = "#00293c", font = "Arial 10",  height = 2, width = 15)
		...
		view_button = Button(window, text = "View",font = "Arial 10", fg = "#006386",bg= "#ccd9ff", highlightbackground="#ccd9ff",cursor = get_handcursor(), height = 1,width = 4, relief = FLAT, command = partial(teacher_view,window,return_function, teachers[i], person))
		view_button.place(x= 330, y = y_position, height=25)
		edit_button = Button(window, text = "Edit",font = "Arial 10", fg = "#006386",bg ="#fff2cc",highlightbackground = "#fff2cc",cursor = get_handcursor(), height = 1,width = 4, relief = FLAT,command = partial(teacher_edit,window,return_function, teachers[i], person))
		...
		delete_button = Button(window, text = "Delete",font = "Arial 10", fg = "#006386",bg ="#ffcccc",highlightbackground= "#ffcccc",cursor = get_handcursor(), height = 1,width = 5, relief = FLAT, command = partial(confirm_deletion,teachers[i]))
