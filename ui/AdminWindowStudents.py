...
def admin_window_students(window,return_function): 
	...
	create_data_text = Button(text = "Create new data", fg = "#e6b800", font="Alice 12",height = 2, width = 15, cursor = "pointinghand", highlightbackground =  "#006386", command = partial(createNew_student,window,return_function))
	...
	first_name = ["abcdefghi","abcdefghi","abcdefghi","abcdefghi","abcdefghi"]
	num_pos_y = 158
	#initial_num = 0
	y_position = 165
	for i in range (len(last_name_students)):
		...
		#initial_num += 1
		last_name_label = Label(window, text = last_name_students[i],fg = "#00293c", font = "Alice 13", height = 2, width = 15)
		last_name_label.place(x = 40, y = num_pos_y)

		first_name_label = Label(window, text = first_name[i],fg = "#00293c", font = "Alice 13",  height = 2, width = 15)
		first_name_label.place(x = 180 , y = num_pos_y)
