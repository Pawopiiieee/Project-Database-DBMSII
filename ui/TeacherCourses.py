...
def course(window, return_function):#this is going to show the course the teacher is currently teaching
	...
	for i in range (len(courses)):
		...
		course_lab = Button(window, text = courses[i],fg = "#00293c", font = "Arial 10",borderwidth=2,cursor = get_handcursor(),command =partial(courseView_students,window,return_function))
		...
		study_lab = Label(window, text = studies[i],fg = "#00293c", font = "Arial 10",  height = 2, width = 25,relief="ridge",borderwidth=2)
