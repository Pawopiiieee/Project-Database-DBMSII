...
def course(window, return_function, teacher, person):#this is going to show the course the teacher is currently teaching
	...
	for i in range (len(courses)):
		...
		course_lab = Button(window, text = courses[i].coursetitle,fg = "#00293c", font = "Arial 10",borderwidth=2,cursor = get_handcursor(),command =partial(courseView_students,window,return_function))
