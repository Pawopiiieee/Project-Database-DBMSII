...
def create_study(window, return_function):
	...
	whole_window.pack()
	header_label = Label(window,text = "Create New Study", fg = "#e6b800", font = "Arial 30", bg ="#006386")
	header_label.place(x = 100, y = 15)

	study_name = Label(window, text = "Title: ",fg = "#006386", font = "Arial 10 bold", bg ="#EBEBE9" )
	study_name.place(x = 20, y = 93)
	input_study = Text(window, height = 1, width = 30, bg = "light yellow", highlightbackground = "#006386", font = "Arial 12")
	input_study.place(x=70, y = 90)

	show_desc = Label(window, text = "Description: ",fg = "#006386", font = "Arial 10 bold", bg ="#EBEBE9" )
	...
	language = Label(window, text = "Select a language: ",fg = "#006386", font = "Arial 10 bold", bg ="#EBEBE9" )
	...
	"""
	amout_year = Label(window, text = "Amount of Years: ",fg = "#006386", font = "Arial 10 bold", bg ="#EBEBE9" )
