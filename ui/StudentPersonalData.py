...
def student_personal_data(window, return_function): #this is going to show personal data
	...
	upper_window.create_text(320, 70, fill = "white", font = "Arial 12", text = "Hi! Legendary Wait_forIt ")
	upper_window_label = Label(window,text = "Profile",fg = "#00293c", font = "Impact 30", bg ="#EBEBE9")
	upper_window_label.place(x = 40, y = 125)
	upper_window.pack()

	name_label = Label(window, text = "Name:  LagendDaily Wait_for_it",fg = "#00293c", font = "Arial 10", bg ="#EBEBE9")
	name_label.place(x = 40, y = 180)
	dob_label = Label(window, text = "Date of Birth:  January 31 1999",fg = "#00293c", font = "Arial 10", bg ="#EBEBE9")
	dob_label.place(x= 40, y = 210)
	address_label = Label(window, text = "Residential Address:  12AB GoldenStraat Amsterdam 1999XY",fg = "#00293c", font = "Arial 10", bg ="#EBEBE9")
	address_label.place(x= 40, y = 210)
	diemenID_label = Label(window, text = "Student ID:  lastname12345",fg = "#00293c", font = "Arial 10", bg ="#EBEBE9")
	diemenID_label.place(x= 40, y = 240)
	diemenEmail_label = Label(window, text = "Email:  lastname@diemenacademy.nl",fg = "#00293c", font = "Arial 10", bg ="#EBEBE9")
	diemenEmail_label.place(x= 40, y = 270)
	study_label = Label(window, text = "Study:  MiddleEarth Magic",fg = "#00293c", font = "Arial 10", bg ="#EBEBE9")
