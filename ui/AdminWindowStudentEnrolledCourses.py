...
def enrolledCourses_students(window, return_function, student):
	...
	student_name_label = Label(window, text = person.lname + "  "+ person.fname, fg = "#006386", font="Arial 10 bold",bg = "#EBEBE9")
