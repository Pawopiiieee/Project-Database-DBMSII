...
def courseView_students(window, return_function):#this is going to show the course the teacher is currently teaching
	...
	courseName_label = Label(window, text = "Course Name",fg = "#006386", font="Alice 13 bold",bg ="#EBEBE9")
	courseName_label.place(x=20, y = 160)

	courseID_label = Label(window, text = "Course ID",fg = "#006386", font="Alice 13 bold",bg ="#EBEBE9")
	courseID_label.place(x=20, y = 190)

	credit_label = Label(window,text = "Credits", fg = "#006386", font = "Alice 13 bold", bg ="#EBEBE9")
	...
	for i in range (len(lastname_students)):
		...
		student_grade = Label(window, height = 2, width = 10, bg = "#F9E79F", font = "Alice 13 bold",relief="ridge",borderwidth=2)
		student_grade.place(x=370, y = num_pos_y)
		num_pos_y += 30
		grade_point.append(student_grade)

	return_course = Button(window,text = "Return", fg = "#2E4053", font = "Alice 15 bold", highlightbackground ="#48C9B0", height = 2,width = 10,borderwidth=2,cursor = "pointinghand", relief="groove", command = partial(ui.TeacherCourses.course,window, return_function))
