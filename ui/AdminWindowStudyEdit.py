...
def study_overview_edit(window, return_function):
	...
	start_year = Label(window, text = "Start Year: ",fg = "#006386", font = "Arial 12 bold", bg ="#EBEBE9" )
	start_year.place(x = 20, y = 470)
	get_year = IntVar()
	year = []
