...
def teacher_window(window): #this is personal, only individual can see the whole detail
	...
	upper_window_text = Label(window,fg = "#e6b800", bg= "#006386", font = "Impact 30", text = "Hello Teacher!")
	upper_window_text.place(x=20,y=25)
	...
	name_text = Label(window, fg = "#e6b800", bg= "#006386", font = "Arial 15", text = "First_name Last_name  \nabc@diemen_academy.nl")
	name_text.place(x=160,y=250)
	upper_window.pack()

	def open_personal_data(): #confidential data
		window.open_teacher_personal(window, teacher_window)
	personal_data_button = Button(window, text = "Personal Data", fg= "#e6b800", font="Courier 18",height = 3,width = 30, 
