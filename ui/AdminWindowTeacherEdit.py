...
def teacher_edit(window, return_function,teacher, person):
	...
	input_teacherID = Text(window, bg = "light yellow", highlightbackground = "#006386", font = "Arial 10")
	input_teacherID.insert(END, teacher.teacherID)
	input_teacherID.place(x=100, y = 130, height = 22, width = 50)

	salary_label = Label(window,text = "Salary", fg = "#006386", font = "Arial 10 bold", bg ="#EBEBE9")
	salary_label.place(x = 250, y = 130)
	input_salary = Text(window, bg = "light yellow", highlightbackground = "#006386", font = "Arial 10")
	input_salary.insert(END, teacher.salary)
	input_salary.place(x=330, y = 130, height = 22, width = 50)

	selected_counsellor = StringVar()
	counsellors = ["Y", "N"]
	counsellor_sh = ttk.Combobox(window,textvariable = selected_counsellor,width = 6, font = "Arial 10")
	...
	courses_button.place(x = 180, y = 190)
	...
	genders = ["M","F","O"]
	gender_sh = ttk.Combobox(window,textvariable = selected_gender,width = 10, font = "Arial 10")
	...
	input_street = Text(window, bg = "light yellow", highlightbackground = "#006386", font = "Arial 10")
